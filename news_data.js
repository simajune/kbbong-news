...
const NEWS = [
  ...
  {cat:"tech", date:"2026-09-20", econ:true, intl:true, country:"미국", size:"대기업", company:"삼성전기", wclass:"세계1위", world:"AI 서버용 MLCC 시장에서 40% 이상 점유율로 세계 선두이며, 글로벌 빅테크와 4개월 만에 누적 4조원대 장기공급계약을 체결했다.", pride:true,
   title:"AI 서버 한 대에 MLCC 수만 개…삼성전기, 빅테크 장기공급 4조 눈앞·점유율 40%",
   desc:"삼성전기가 글로벌 빅테크와 AI 서버용 적층세라믹커패시터(MLCC) 추가 공급 계약 막바지 협상에 들어갔다. 성사되면 최근 4개월간 체결한 장기공급계약 누적 규모가 4조원을 넘어선다. 앞서 9월 1일에는 한 빅테크와 2027년 한 해 공급분만 1조722억원 규모로 계약해 단일 건 역대 최대를 기록했다. MLCC는 전기를 저장했다 필요한 만큼 흘려보내는 '전자산업의 쌀'로, AI 서버에는 일반 서버보다 10배 이상 많은 양이 들어간다. 전력 소모가 큰 AI 가속기일수록 고온·고전압을 견디는 고신뢰성 제품이 필수인데, 이 영역에서 삼성전기는 40% 이상의 점유율로 세계 선두를 지키고 있다. 일본 무라타가 장악해온 시장에서 한국 기업이 AI라는 새 판이 열리자마자 주도권을 가져간 사례다. 엔비디아·빅테크가 아무리 칩을 잘 만들어도 이 작은 부품이 없으면 서버가 돌지 않는다.",
   src:"머니투데이", url:"https://www.mt.co.kr/industry/2026/09/20/2026092015574728315",
   yt:3, ytnote:"쌀알보다 작은데 4조원 — AI 서버가 삼성전기 없이는 못 돌아가는 이유",
   videos:[], related:[]},
  ...
  {cat:"tech", date:"2026-09-17", econ:true, intl:true, country:"미국", size:"대기업", company:"삼성전자", wclass:"세계1위", world:"2026년 상반기 글로벌 스마트폰 출하량 점유율 21.8%로 세계 1위이며, 2022년 이후 가장 높은 수준이다.", pride:true,
   title:"애플도 중국도 아니었다…삼성전자, 상반기 스마트폰 점유율 21.8%로 세계 1위 탈환",
   desc:"2026년 상반기 글로벌 스마트폰 출하량 기준 삼성전자가 점유율 21.8%로 1위를 차지했다. 2022년 이후 가장 높은 수준으로, 중국 업체들의 저가 공세와 애플의 프리미엄 장악 사이에서 점유율이 깎여 나가던 흐름을 되돌린 결과다. 갤럭시 브랜드를 글로벌 주요 시장과 대형 행사에 집중 노출시키며 존재감을 키운 전략이 맞아떨어졌다는 분석이 나온다. 스마트폰은 AP·메모리·카메라모듈·디스플레이·배터리까지 한 나라의 전자 생태계 전체를 끌고 가는 품목이라, 완제품 1위는 그 아래 수백 개 부품 협력사의 물량으로 직결된다. 한국이 반도체뿐 아니라 세트(완제품) 영역에서도 세계 1위를 지키고 있다는 점에서 의미가 다르다.",
   src:"한국경제", url:"https://www.hankyung.com/article/202609171431g",
   yt:3, ytnote:"깎여나가던 점유율을 어떻게 되돌렸나 — 삼성 스마트폰 21.8% 세계 1위의 속사정",
   videos:[], related:[]},

  {cat:"kpop", date:"2026-08-31", econ:false, intl:true, country:"미국", size:"대기업", company:"엔하이픈", wclass:"세계1위", world:"미국 빌보드 메인 앨범차트 '빌보드 200' 1위에 올랐고, K팝 앨범이 3주 연속으로 이 차트 정상을 지킨 새 기록을 만들었다.", pride:true,
   title:"데뷔 6년 만에 정상…엔하이픈 '빌보드 200' 1위, K팝 앨범 3주 연속 1위 새 역사",
   desc:"엔하이픈이 새 앨범 'THE SIN: BLISS'로 미국 빌보드 메인 앨범차트 '빌보드 200' 1위에 올랐다. 2020년 데뷔 후 6년 만의 첫 정상이자, 6인 체제로 재편된 뒤 내놓은 첫 앨범이다. 의미는 개별 그룹의 기록을 넘어선다. 이 1위로 K팝 앨범이 빌보드 200 정상을 3주 연속 지키는 진기록이 만들어졌기 때문이다. 미국 앨범차트 1위 자리를 특정 장르가 3주 내리 점유한다는 것은, 팬덤의 초동 화력으로 한 주 올라갔다 내려오는 이벤트가 아니라 K팝이라는 카테고리 자체에 미국 시장의 상시 수요가 깔려 있다는 뜻이다. 첫 주 18위에서 출발했던 팀이 6년에 걸쳐 1위까지 올라온 성장 서사도 현지에서 함께 주목받았다.",
   src:"스타뉴스", url:"https://www.starnewskorea.com/music/2026/08/31/2026083108301779970",
   yt:4, ytnote:"K팝 앨범이 빌보드 200을 3주 연속 점령했다 — 이벤트가 아니라 수요라는 증거",
   videos:[{t:"[문화연예 플러스] 엔하이픈 '빌보드 200' 1위 (2026.09.01/뉴스투데이/MBC)", u:"https://www.youtube.com/watch?v=Th2llYwxo2M"},
           {t:"K팝 가수들, '빌보드 200' 3주 연속 1위 [잇슈 컬처] / KBS 2026.09.01.", u:"https://www.youtube.com/watch?v=l88EvKP9pLk"},
           {t:"[K-Enter] ENHYPEN tops the Billboard 200 for the first time since debut", u:"https://www.youtube.com/watch?v=vPsIdRYlYHg"}],
   related:[{t:"엔하이픈 빌보드 200 1위! 18위서 시작한 역대급 성장 서사 (YouTube Shorts)", u:"https://www.youtube.com/shorts/wo7FNC1_HIE"},
            {t:"Billboard 200 #1 - We did it, ENGENE ✨ #THE_SIN_BLISS #ENHYPEN", u:"https://www.youtube.com/shorts/RS_-mtho45Q"}]},

  {cat:"kpop", date:"2026-09-15", econ:false, intl:true, country:"미국", size:"대기업", company:"제니", wclass:"해외인정", world:"빌보드 '핫100' 톱10 최장 기간 기록을 K팝 가수 중 처음으로 갈아치우며 방탄소년단이 갖고 있던 기록을 넘어섰다.", pride:true,
   title:"BTS 기록을 넘었다…제니, 빌보드 '핫100' K팝 최장 톱10",
   desc:"블랙핑크 제니가 빌보드 메인 싱글차트 '핫100' 톱10에 K팝 가수로는 가장 오래 머무는 기록을 세우며, 방탄소년단이 갖고 있던 기록을 넘어섰다. 핫100은 미국 내 스트리밍·라디오 방송 횟수·음원 판매량을 합산하는 차트라 팬덤 화력만으로는 상위권을 오래 유지하기 어렵다. 특히 라디오 방송 횟수는 미국 현지의 일반 대중이 얼마나 그 곡을 계속 듣는지를 보여주는 지표인데, 제니는 앞서 빌보드 라디오 차트 1위에도 올랐다. 호주 밴드 테임 임팔라와 협업한 곡이 톱10에 진입하는 등 영어권 아티스트와의 공동작업으로 현지 주류 시장에 직접 발을 들이는 방식을 택했다. K팝 솔로 아티스트가 미국 차트에서 '반짝'이 아니라 '체류'로 평가받기 시작했다는 신호다.",
   src:"서울신문", url:"https://www.seoul.co.kr/news/life/pop-culture/2026/09/15/20260915500197",
   yt:3, ytnote:"팬덤 화력으로는 못 버티는 차트 — 제니가 미국 라디오를 뚫고 톱10에 오래 남은 방법",
   videos:[], related:[]},
