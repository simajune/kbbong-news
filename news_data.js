...
const NEWS = [
  ...
  {cat:"tech", date:"2026-02-09", econ:true, intl:false, size:"중견", company:"한미반도체", wclass:"세계1위", world:"HBM 제조의 핵심 장비인 TC본더 세계 시장을 점유율 71.2%로 사실상 독점해, SK하이닉스·마이크론 등 글로벌 메모리 업체가 이 인천 중견기업의 장비 없이는 HBM을 쌓지 못한다.", pride:true,
   title:"한미반도체, HBM용 TC본더 세계 점유율 71.2%…AI 메모리 장비 사실상 독점",
   desc:"한미반도체가 글로벌 고대역폭메모리(HBM)용 TC(열압착) 본더 시장에서 누적 매출 2억4770만달러(약 3660억원), 점유율 71.2%로 압도적 1위를 지켰다. 2위는 삼성전자 자회사 세메스(10%대), 3위는 올해 처음 납품을 시작한 한화세미텍(3%대)이다. TC본더는 HBM 공정에서 메모리 칩을 고온·고압으로 정밀 접합하는 필수 장비로, AI 반도체 수요 폭증과 함께 글로벌 메모리 기업의 필수재가 됐다. 한미반도체는 HBM4용 'TC 본더 4' 양산 체제를 갖췄고, 인천 주안산단에 1000억원을 투입한 하이브리드 본더 공장을 올해 말 완공해 HBM5·HBM6 시대를 준비한다.",
   src:"시사저널e", url:"https://www.sisajournal-e.com/news/articleView.html?idxno=417986",
   yt:3, ytnote:"엔비디아도 삼성도 못 만드는 장비 — 인천 중견기업이 AI 메모리의 목을 쥔 방법",
   videos:[],
   related:[{t:"한미반도체 HBM TC 본더 세계 점유율 71%…세계 1위 (디지털데일리)", u:"https://m.ddaily.co.kr/page/view/2025122209443632881"},
            {t:"TC본더 시장 활짝…한미반도체·한화세미텍 '안방 싸움' (뉴스1)", u:"https://v.daum.net/v/20260304172902204"}]},

  {cat:"tech", date:"2026-03-30", econ:true, intl:false, size:"대기업", company:"SK하이닉스", wclass:"세계1위", world:"엔비디아가 쓰는 HBM 물량의 약 70%를 SK하이닉스 한 곳이 대고 있고 전체 HBM 점유율도 50%를 넘어, 전 세계 AI 가속기의 메모리 공급망이 한국 두 회사에 묶여 있다.", pride:true,
   title:"엔비디아 HBM 물량 70%가 한국산…SK하이닉스, HBM4에서도 선두 굳혔다",
   desc:"엔비디아 공급망이 HBM 승부를 갈랐다. SK하이닉스는 H100·H200·블랙웰 등 엔비디아 주력 GPU에 HBM을 선제 공급해 왔고, HBM4 세대에서도 엔비디아 물량의 약 70%를 확보한 것으로 알려졌다. 골드만삭스는 최소 2026년까지 SK하이닉스가 HBM3·HBM3E를 앞세워 전체 HBM 시장 점유율 50% 이상을 유지할 것으로 봤다. 2025년 기준 HBM 점유율은 SK하이닉스 61%, 마이크론 22%, 삼성전자 18%로 한국 두 회사가 약 80%를 차지한다. 삼성전자가 2월 HBM4 세계 최초 양산 출하로 반격에 나서면서, AI 메모리 1·2위 싸움 자체가 한국 안에서 벌어지는 구도가 됐다.",
   src:"뉴데일리경제", url:"https://biz.newdaily.co.kr/site/data/html/2026/03/30/2026033000155.html",
   yt:3, ytnote:"AI 반도체의 진짜 병목은 한국에 있다 — HBM 점유율 80%의 의미",
   videos:[],
   related:[{t:"[기업認] SK하이닉스, 엔비디아향 HBM 점유율 1위 자리 굳건 (딜사이트경제TV)", u:"https://news.dealsitetv.com/articles/163761"},
            {t:"2026년 시장 전망… \"HBM이 이끄는 메모리 슈퍼사이클에 주목\" (SK하이닉스 뉴스룸)", u:"https://news.skhynix.co.kr/2026-market-outlook/"}]},

  {cat:"tech", date:"2026-01-07", econ:true, intl:true, country:"미국", size:"중소", company:"국내 중소·벤처기업 다수", wclass:"해외인정", world:"CES 2026 혁신상 1차 수상 284개사 중 한국이 168개사로 미국(54)·중국(34)·대만(13)을 압도했고, 그중 81%가 중소·벤처기업이었다.", pride:true,
   title:"CES 2026 혁신상 60%가 한국…수상기업 81%는 중소·벤처, 미국·중국을 압도했다",
   desc:"미국소비자기술협회(CTA)가 발표한 CES 2026 혁신상 1차 결과에서 전체 수상기업 284개사 중 한국 기업이 168개사로 1위를 차지했다. 미국 54개사, 중국 34개사, 대만 13개사를 큰 격차로 제친 수치다. 더 주목할 대목은 구성으로, 한국 수상기업의 81%인 137개사가 중소·벤처기업이었다. 올해 혁신상에는 3600개가 넘는 제품이 출품됐고, 한국에서는 삼성·LG·현대차·SK 같은 대기업부터 스타트업까지 약 1000개사가 참가해 역대 최대 규모 통합관을 꾸렸다. 외신들은 로봇·엣지 AI·산업 AI 등 '피지컬 AI' 영역에서 한국 딥테크 스타트업의 경쟁력이 전면에 드러난 해로 평가했다.",
   src:"KoreaTechDesk", url:"https://koreatechdesk.com/ces-innovation-awards-2026-korea-physical-ai",
   yt:3, ytnote:"대기업이 아니라 중소기업이 쓸어담았다 — CES 혁신상 60% 한국의 속사정",
   videos:[],
   related:[{t:"Over 80% of Korean Companies Winning 'Innovation Award' at CES 2026 Are SMEs (아시아경제)", u:"https://cm.asiae.co.kr/en/article/2025123118454293231"},
            {t:"한국 기업들, 'CES 2026' 혁신상 휩쓸어…글로벌 판로 개척 본격화 (정책브리핑)", u:"https://www.korea.kr/news/policyNewsView.do?newsId=148957660"}]},
